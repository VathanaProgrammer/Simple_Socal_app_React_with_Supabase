...
function CreatePost() {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      navigate("/"); // ✅ Go back to Home automatically
    } catch (err) {
      console.error(err);
  ...
  return (
    <Layout>
      ...
      <div className="max-w-lg w-full h-[80vh] lg:h-[70vh] 2xl:h-[60vh] mx-auto flex items-center justify-center p-1">
        <div className="bg-white w-full h-full flex flex-col rounded-lg p-6 border border-gray-300 relative">
